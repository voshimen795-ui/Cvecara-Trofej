...
function Stars({ rating }) {
  return (
    <span className="flex gap-0.5" aria-label={`${rating} od 5 zvezdica`}>
      ...
      <figcaption className="mt-5 flex items-center gap-3 border-t border-brand-border/70 pt-4">
        ...
        <span className="min-w-0">
          ...
          <span className="mt-0.5 flex items-center gap-2">
            ...
            <span className="text-xs text-brand-muted">{review.when}</span>
          </span>
        </span>
      </figcaption>
    </figure>
  ...
  return (
    <section id="recenzije" className="scroll-mt-24 overflow-hidden bg-brand-mist/50 py-16 lg:py-24">
      <div className="container-editorial text-center">
        ...
        <h2 className="mt-2 font-serif text-3xl text-brand-dark sm:text-4xl">Šta kažu mušterije</h2>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
          ...
          >
            {GOOGLE.count} recenzija na Google-u
