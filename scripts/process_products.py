...
MANIFEST: list[Item] = [
    ...
    # ——— druga tura fotografija ———
    Item("8bc72f9e-10034.jpg", "cvetni-vez", "buketi", trim_bottom=0.16),
    Item("8896f4ea-10062.jpg", "tirkizni-buket", "buketi"),
    Item("ed674ec7-10064.jpg", "pastelna-prica", "buketi", trim_bottom=0.12),
    Item("110b2e4c-10055.jpg", "nezni-pozdrav", "buketi", trim_bottom=0.25),
    Item("6251852f-10054.jpg", "zuti-sjaj", "buketi", trim_bottom=0.20),
    Item("03f2d494-10076.jpg", "purpurna-dalija", "buketi"),
    Item("92cb576a-10049.jpg", "ljubicasta-elegancija", "buketi", trim_bottom=0.14),
    Item("45a242ef-10057.jpg", "meki-pastel", "buketi", trim_bottom=0.24),
    Item("8e8ed959-10080.jpg", "bela-elegancija", "buketi"),
    Item("dc356109-10088.jpg", "ljiljan-i-ruze", "buketi", trim_bottom=0.30,
         note="tamni rukav; drop_dark je fragmentirao masku, sečenje radi bolje"),
    Item("85f7744e-10121.jpg", "poljski-vez", "buketi", trim_bottom=0.16),
    Item("11666cd5-10107.jpg", "roze-romansa", "buketi"),
    Item("2f159d99-10390.jpg", "slatki-pozdrav", "aranzmani"),
